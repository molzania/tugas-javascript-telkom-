...
/// EDIT HERE
function checkDrivingLicense(userAge, drivingLicense) {
    if(userAge < 18) {
...
console.log(checkDrivingLicense(18, true));
...
suhuKelvin = temperature + 273;
suhuCelcius = temperature;
suhuFahrenheit = ((9/5) * temperature) + 32
switch (unit) {
  /// EDIT HERE
  case 'K': console.log(suhuKelvin);
  break;
  case 'F':  console.log(suhuFahrenheit);
  break;
  case 'C':  console.log(suhuCelcius);
    break;
